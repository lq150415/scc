...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 22-06-2017 a las 11:45:07
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='Es el tipo de archivo';

--
-- Volcado de datos para la tabla `archivo`
--

INSERT INTO `archivo` (`id`, `titulo`, `descripcion`, `activo`, `created_at`, `updated_at`) VALUES
(1, 'Avance', NULL, 1, NULL, NULL),
(2, 'Concierto Español', NULL, 1, NULL, NULL),
(3, 'Concierto Ingles', NULL, 1, NULL, NULL),
(4, 'Concierto Subtitulado', NULL, 1, NULL, NULL),
(5, 'Documental', '', 1, NULL, NULL),
(6, 'Enseñanza', NULL, 1, NULL, NULL),
(7, 'Entrevista', NULL, 1, NULL, NULL),
(8, 'Especial', NULL, 1, NULL, NULL),
(9, 'Identificaciones', NULL, 1, NULL, NULL),
(10, 'Infantil', NULL, 1, NULL, NULL),
(11, 'Microprograma Español', NULL, 1, NULL, NULL),
(12, 'Microprograma Subtitulada', NULL, 1, NULL, NULL),
(13, 'Musical Español', NULL, 1, NULL, NULL),
(14, 'Musical Ingles', NULL, 1, NULL, NULL),
(15, 'Musical Subtitulada', NULL, 1, NULL, NULL),
(16, 'Pelicula Español', NULL, 1, NULL, NULL),
(17, 'Pelicula Ingles', NULL, 1, NULL, NULL),
(18, 'Pelicula Subtitulada', NULL, 1, NULL, NULL),
(19, 'Predica Doblada', NULL, 1, NULL, NULL),
(20, 'Predica Español', NULL, 1, NULL, NULL),
(21, 'Programa local', NULL, 1, NULL, NULL),
(22, 'Promocionales', NULL, 1, NULL, NULL),
(23, 'Publicidad', NULL, 1, NULL, NULL),
(24, 'Revista', NULL, 1, NULL, NULL),
(25, 'Testimonio', NULL, 1, NULL, NULL);
...
INSERT INTO `articulos` (`id`, `TIT_ART`, `PRE_ART`, `ID_CAT`, `ID_MAT`, `created_at`, `updated_at`) VALUES
(1, 'En la selva Somos uno en Cristo', '25', 15, 114, '2016-07-01 04:54:01', '2016-07-01 04:54:01'),
(2, 'Hombria al maximo - Hombres de valor', '25', 18, 115, '2016-07-01 05:15:15', '2016-07-01 05:15:15'),
(4, 'Paquete plus 2x1', '40', 25, 0, '2017-01-30 14:09:12', '2017-01-30 14:09:12'),
(5, 'Pack Jose Ordoñez', '50', 25, 0, '2017-03-28 03:01:35', '2017-03-28 03:01:35');
...
(21, 'Conciertos', 'Conciertos', 3, '0000-00-00 00:00:00', '2017-01-19 00:30:47'),
(24, 'Generacion de fuego', 'Generacion de fuego', 3, '2016-06-04 03:00:51', '2016-06-04 03:00:51'),
(25, 'Paquetes', 'Paquetes', 3, '2017-01-30 12:46:48', '2017-01-30 12:46:48');
...
(17, 'Faustino', 'Mayta', 'Mamani', 66587987, 'LA PAZ', 'famama@gmail.com', '2016-05-05 22:41:27', '2017-01-30 16:44:58'),
...
(20, 'Rodrigo', 'Casas', 'Paredes', 71247546, 'calle montaño', 'rocasas@gmail.com', '2016-12-16 11:59:32', '2016-12-16 11:59:32'),
(21, 'Luis', 'Quisbert', 'Quispe', 2656543, 'LA PAZ', 'luis_fqq@hotmail.com', '2017-01-30 12:25:03', '2017-01-30 23:23:24'),
(22, 'Marco', 'Mamani', 'Diaz', 432542423, 'fdsagfads', 'marcoantonimamanidiaz645@gmail.com', '2017-03-28 00:50:08', '2017-03-28 00:50:08');
...
INSERT INTO `empaquetados` (`id`, `ID_PAQ`, `ID_ART`, `created_at`, `updated_at`) VALUES
(1, 2, 1, '2017-01-30 14:09:48', '2017-01-30 14:09:48'),
(2, 2, 2, '2017-01-30 14:09:48', '2017-01-30 14:09:48'),
(3, 3, 1, '2017-03-28 03:01:35', '2017-03-28 03:01:35'),
(4, 3, 2, '2017-03-28 03:01:35', '2017-03-28 03:01:35');
...
INSERT INTO `material` (`id`, `ID_USU`, `COD_MAT`, `TIT_MAT`, `SUB_MAT`, `ANP_MAT`, `DUR_MAT`, `DIR_MAT`, `PAI_MAT`, `GUI_MAT`, `ID_GEN`, `EST_MAT`, `RES_MAT`, `COM_MAT`, `POR_MAT`, `ID_UBI`, `DES_UBI`, `ACT_MAT`, `NRO_PRO`, `ID_PRO`, `ID_ARC`, `created_at`, `updated_at`, `TAG_MAT`) VALUES
(0, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(1, 1, 'IE-1', 'AUTO B GOOD (O)', 'PONGAMONOS EN CAMINO', 2012, '01:00:00', '', '', '', 10, '', '1', '6 CAPITULOS QUE HACEN UN TOTAL DE TIEMPO UNA HORA', 'X', 2, 'BLOQUE-4', 1, 0, 5, 17, NULL, NULL, NULL),
(2, 1, 'IE-2', 'AUTO B GOOD (O)', 'PONGAMONOS EN CAMINO', 0, '01:00:00', '', '', '', 10, '', '1', '6 CAPITULOS QUE HACEN UN TOTAL DE TIEMPO UNA HORA', 'X', 2, 'BLOQUE-4', 1, 0, 5, 17, NULL, NULL, NULL),
(3, 1, 'IE-3', 'AUTO B GOOD (O)', 'RASGOS DE LA FE', 2014, '02:14:00', '', '', '', 10, '', '1', 'LECCION ACERCA DE LA SABIDURIA, EL PERDON, LA SINCERIDAD Y MUCHO MAS. 10 EMOCIONANTES EPISODIOS', 'X', 2, 'BLOQUE-4', 1, 0, 5, 17, NULL, NULL, NULL),
(4, 1, 'IE-4', 'AUTO B GOOD (O)', 'LOS FRUTOS DEL ESPIRITU', 2014, '02:10:00', '', '', '', 10, '', '1', 'LECCIONES ACERCA DEL GOZO, LA LEALTAD, LA BONDA Y MUCHO MAS. 10 EMOCIONANTES EPISODIOS', 'X', 2, 'BLOQUE-4', 1, 0, 5, 17, NULL, NULL, NULL),
(5, 1, 'IE-5', 'AUTO B GOOD (O)', 'SABIDURIA DE LO ALTO', 0, '02:09:00', '', '', '', 10, '', '1', 'LECCIONES ACERCA DE LA CORTESIA, LA JUSTICIA, LAAUTOESTIMA Y MUCHO MAS. 10 EMOCIONANTES EPISODIOS', 'X', 2, 'BLOQUE-4', 1, 0, 5, 17, NULL, NULL, NULL),
(6, 1, 'IE-6', 'AUTO B GOOD (O)', 'DANDOLE LOS NEUMATICOS SE UNEN A LA CALLE', 2009, '01:00:00', '', '', '', 10, '', '1', 'TOLERANCIA, CONCIDERACION, UNIDAD, PATRIOTISMO, CIUDADNIA Y LEALTAD. 6 EPISODIOS', 'X', 2, 'BLOQUE-4', 1, 0, 5, 17, NULL, NULL, NULL),
(7, 1, 'PE-1', 'BEN HUR (O)', 'BEN HUR', 2005, '01:20:00', '', '', '', 34, '', '1', 'Durante el siglo primero antes de Cristo, Ben Hur es un joven príncipe hebreo que es esclavizado por los romanos. Después de un trágico accidente y de forma heroica regresa con su familia y se enamora perdidamente de una hermosa esclava lo que se hace un conflicto con sus amigos. Estos dramáticos eventos se desarrollan en el marco de la vida y muerte de cristo constituyendo una obra imposible de olvidar y que cautivara a personas de todas las edades y en todas las épocas.', 'X', 2, 'BLOQUE-1', 1, 0, 5, 11, NULL, NULL, NULL),
(8, 1, 'ME-1', 'EL NUEVO MUNDO DE BIPER (O)', 'VOL. 1', 2012, '00:55:00', '', '', '', 33, '', '1', 'Un mundo donde podrás encontrar aventuras música y diversión junto a Biper ', 'X', 2, 'BLOQUE-3', 1, 0, 5, 80, NULL, NULL, NULL),
(9, 1, 'IE-0007', 'CHIQUISAURIOS (O)', 'CUENTOS DEL ABUELITO', 2009, '00:33:00', '', '', '', 13, '', '1', 'La popular colección de "Cuentos de la abuelita" ', 'X', 2, 'BLOQUE-4', 1, 0, 5, 17, NULL, NULL, NULL),
(10, 1, 'IE-8', 'EL DESVAN DEL TIO IVAN (O)', 'MAGNIFICO UNIVERSO Y POR TODO EL MUNDO', 2009, '00:50:00', '', '', '', 11, '', '1', 'Con estos episodios de EL DESVAN DEL TIO IVAN los chicos aprenden una emocionante gira didáctica por el mundo. descubre así junto al tío Ivan, Ojitos y Conejin Palabrin maravillas del medio ambiente, no solo en nuestro planta, sino en el espacio sideral.', 'X', 2, 'BLOQUE-4', 1, 0, 5, 17, NULL, NULL, NULL),
(11, 1, 'IE-9', 'EL DESVAN DEL TIO IVAN (O)', 'EL VIAJE INCREIBLE Y MI MEJOR AMIGO', 2007, '00:56:00', '', '', '', 11, '', '1', 'Apasionante recorrido por la biblia de la mano del tío Iván y sus amiguitos', 'X', 2, 'BLOQUE-4', 1, 0, 5, 17, NULL, NULL, NULL),
(12, 1, 'IE-10', 'EL DESVAN DEL TIO IVAN (O)', 'UN DIA EN EL CAMPO Y UNA SONRISA', 2009, '00:56:00', '', '', '', 11, '', '1', 'Aventuras llenas de sorpresas en el desván del tío Iván. ', 'X', 2, 'BLOQUE-4', 1, 0, 5, 17, NULL, NULL, NULL),
(13, 1, 'IE-10', 'EL DESVAN DEL TIO IVAN (O)', 'EL JARDIN Y VAMOS DE CAMPING', 0, '00:50:00', '', '', '', 11, '', '1', 'Una animadísima aventura educativa. llena de dinámica, canciones, actividades y muñecos que divierten y enseñan a la vez. ', 'X', 2, 'BLOQUE-4', 1, 0, 5, 17, NULL, NULL, NULL),
(14, 1, 'PS-1', 'BE STILL (O)', 'AND KNOW THAT I AM GOD', 2006, '01:33:00', '', '', '', 35, '', '1', 'BE STILL is an extraordinary film that demonstrates how contemplative, or "listening", prayer can be a vital way to find peace vin the mist of a frenzied, fast-paced, moder world.', 'X', 2, 'BLOQUE-1', 1, 0, 5, 104, NULL, NULL, NULL),
(15, 1, 'PE-2', 'TIME CHANGER (O)', 'THE MAKING OF TIME CHANGER', 2002, '00:53:00', '', '', '', 18, '', '1', 'THE YEAR IS 1890AND BIBLE PROFESSOR RUSSELL CARLISLE (D. DAVID MORIN) HAS WRITTEN A NEW MANUSCRIPT ENTITLED "THE CHANGING TIMES" HIS BOOK IS ABOUT TO RECEIVE A UNANIMOUS ENDORSEMENT FRON THE BOARD MEMBERS OF THE GRACE BIBLE SEMINARY UNTIL HIS COLLEAGUE DR. NORRIS ANDERSON (GAVIN MACLEOD) RAISES AND OBJETION.', 'X', 2, 'BLOQUE 1', 1, 0, 5, 11, NULL, NULL, NULL),
(16, 1, 'PE-3', 'BEHIND THE SUN (O)', 'A YOUNG MAN''S CHOICE. A FATHER''S PAIN.', 1995, '00:56:00', '', '', '', 14, '', '1', 'Behind the sun followsthe story of Samir Majan, a young man born and raised a Muslim in the Middle East who attended college in America.', 'X', 2, 'BLOQUE-1', 1, 0, 5, 11, NULL, NULL, NULL),
(17, 1, 'PE-4', 'LA SUBASTA DE UN ALMA (O)', '', 1989, '01:55:00', '', '', '', 14, '', '1', 'La subasta de un alma, es una presentación del ministerio mizpa; grabado en los estudios de La Cadena Del Milagro, Cumuy, Puerto Rico, Ministerio Cristo viene 1989', 'X', 2, 'BLOQUE-1', 1, 0, 5, 11, NULL, NULL, NULL),
(18, 1, '01/15', 'EN LA SELVA', '1ERA Y 2DA MEDIA HORA', 2015, '00:58:17', '', 'BOLIVIA', '', 36, '', '1', '1ERA. MEDIA HORA: FABRICA DE CONFESIONES¿ES MALO CONSULTAR HOROSCOPOS?\r\n2DA. MEDIA HORA: INVITADO: BANDA NOIS, HABLAN ACERCA DE COMO INICIÓ BANDA Y PRESENTAN SUS CANCIONES.', 'X', 2, 'ESTANTE 1 - FILA 5', 1, 0, 4, 152, NULL, NULL, NULL),
(19, 1, '02/15', 'EN LA SELVA', '1ERA Y 2DA MEDIA HORA ', 2015, '00:59:17', '', 'BOLIVIA', '', 36, '', '1', '1ERA MEDIA HORA: LECTURA: CARISMA VS, CARÁCTER ¿CUÁL ES MÁS IMPORTANTE? POR: RICK WARREN\r\n2DA MEDIA HORA: INVITADO: NO HAY, SÓLO SE PRESENTARON VIDEO CLIPS', 'X', 2, 'ESTANTE 1 - FILA 5', 1, 0, 4, 152, NULL, NULL, NULL),
(20, 1, '03/15', 'EN LA SELVA', '2DA MEDIA HORA', 2015, '00:28:16', '', 'BOLIVIA', '', 36, '', '1', '2DA MEDIA HORA: INVITADO A DISTANCIA: COMUNICADOR - PATO PETERS\r\nPRESENTACIÓN SOBRE LA HISTORIA DE PETERS, CUENTA SOBRE SU EXPERIENCIA LABORAL (MÚSICA).', 'X', 2, 'ESTANTE 1 - FILA 5', 1, 0, 4, 152, NULL, NULL, NULL),
(21, 1, '04/15', 'EN LA SELVA', '1ERA Y 2DA MEDIA HORA ', 2015, '00:58:29', '', 'BOLIVIA', '', 36, '', '1', '1ERA MEDIA HORA: LECTURA: UNA VEZ GAY, ¿SIEMPRE GAY? NO NECESARIAMENTE POR: LEE GRADY.\r\n2DA MEDIA HORA: INVITADO 1: ISABEL FLORES, REPRESENTANTE ESCUELA DE PADRES. CONTENIDO: PUBLICIDAD PARA LA INSCRIPCIÓN.\r\nINVITADO 2: MAURICIO TOLEDO, ACTOR. \r\nCONTENIDO: TOLEDO CUENTA SOBRE SU EXPERIENCIA LABORAL.', 'X', 2, 'ESTANTE 1 - FILA 5', 1, 0, 4, 152, NULL, NULL, NULL),
(22, 1, '05/15', 'EN LA SELVA', '1ERA Y 2DA MEDIA HORA ', 2015, '00:56:15', '', 'BOLIVIA', '', 36, '', '1', '1ERA MEDIA HORA: NO HAY, SÓLO SE PRESENTARON VIDEO-CLIPS.\r\n2DA MEDIA HORA: INVITADO 1: MIGUEL PACO (BATERISTA)   CONTENIDO: EXPLICA SOBRE DE CÓMO COMENZÓ Y  SU MÚSICA A NIVEL NACIONAL, EXPLICA SU ÚLTIMA MÚSICA PARA MÁS ADELANTEY PRESENTÓ SU MÚSICA SITUACIÓN FT. AJAYU "MI TIERRA".\r\nINVITADO 2: GRUPO - BANDA LAGARTOS  CONTENIDO: CUENTA SOBRE CUÁNTO TIEMPO SE LLEVARON SU GRUPO, EXPLICA EL PROCESO DE SU BANDA Y PRESENTARON EL VIDEO CLIPS "SOLO SEXO".', 'X', 2, 'ESTANTE 1 - FILA 5', 1, 0, 4, 152, NULL, NULL, NULL),
(23, 1, '06/15', 'EN LA SELVA', '1ERA Y 2DA MEDIA HORA ', 2015, '00:59:00', '', 'BOLIVIA', '', 36, '', '1', '1ERA MEDIA HORA: FABRICA DE CONSESIONES: ¿QUÉ OPINA DIOS DEL RACISMO? \r\n2DA MEDIA HORA: INVITADO: RAFAEL CAMBRONERO - CANTAUTOR    CONTENIDO: PRESENTACIÓN SOBRE SU BIOGRAFÍA, CUENTA SU HISTORIA DE VIDA, TAMBIÉN EXPLICA SOBRE LA IGLESIA Y LA MÚSICA, Y PRESENTÓ LA MÚSICA "VIVO PARA TÍ".', 'X', 2, 'ESTANTE 1 - FILA 5', 1, 0, 4, 152, NULL, NULL, NULL),
(24, 1, '07/15', 'EN LA SELVA', '1ERA Y 2DA MEDIA HORA ', 2015, '00:59:12', '', 'BOLIVIA', '', 0, '', '1', '1ERA MEDIA HORA: LECTURA: LA VERDADERA INTERSECIÓN POR: OMAYRA FONT.\r\n2DA MEDIA HORA: INVITADO: GRUPO MINISTERIO ASAF.  CONTENIDO: PRESENTACIÓN DE LA BANDA "MINISTERIO ASAF", CUENTA SOBRE DE CÓMO SE HA FORMADO EL GRUPO, PRESENTARON LA MÚSICA: "EL MAESTRO" Y "LA PESADILLA", Y AL FINAL SE PRESENTARON UNA PEQUEÑA MUESTRA DEL VIDEO CLIPS.', 'X', 2, 'ESTANTE 1 - FILA 5', 1, 0, 4, 152, NULL, NULL, NULL),
(25, 1, '08/15', 'EN LA SELVA', '1ERA Y 2DA MEDIA HORA', 2015, '00:59:29', '', 'BOLIVIA', '', 0, '', '1', '1ERA MEDIA HORA: FABRICA DE CONSESIONES: ¿CÓMO AYUDAR A QUE DOS PERSONAS SE RECONCILIEN?  \r\n2DA MEDIA HORA: INVITADO: REBECCA VÁSQUEZ LAMARTÍN - CANTANTE     CONTENIDO: PRESENTACIÓN DE SU EXPERIENCIA LABORAL, CUENTA SU HISTORIA, EXPLICA DE CÓMO EMPEZÓ A TRABAJAR, PRESENTÓ LA MÚSICA "REINA SENHOR". EXPLICA DE CÓMO EMPEZÓ A PRODUCIR SU MÚSICA, Y POR ÚLTIMO SE PRESENTÓ UN VIDEO CLIP "ELE ME CHAMA".\r\n', 'X', 2, 'ESTANTE 1 - FILA 5', 1, 0, 4, 152, NULL, NULL, NULL),
...
(36, 1, '10/15', 'EN LA SELVA', '2DA MEDIA HORA', 2015, '00:22:02', '', 'BOLIVIA', '', 36, '', '1', '2DA MEDIA HORA: INVITADO: REPRESENTANTE DEL GRUPO GODS    CONTENIDO: PRESENTACIÓN PARA LA PUBLICIDAD DE SU MÚSICA, EXPLICA SOBRE DE CÓMO EMPEZÓ LA MÚSICA Y TAMBIÉN INFORMA SOBRE LA PRESENTACIÓN MÚSICA, Y MOSTRARON SU MÚSICA EN EL SET. TAMBIÉN CUENTA SOBRE LA BIOGRAFÍA DE CADA UNO, Y AL FINAL PRESENTÓ UN VIDEO CLIP.', 'X', 2, 'ESTANTE 1 - FILA 5', 1, 0, 4, 152, NULL, NULL, NULL),
...
(93, 1, 'I', 'INQUEBRANTABLE', 'LA JUVENTUD DE JOSH MCDOWELL', 2011, '01:08:00', '', '', '', 18, '', '1', 'Josh McDowell nació a la cruel realidad de la vida. El alcoholismo de su padre, que lo hacía violento, aparejado con un abuso sexual sufrido en su infancia llenaron a McDowell de verguienza. Con los años, eso lo alejó más y mpas de Cristo, hasta que finalmente se convirtió en ira. Ansioso por clamar contra la existnecia de Dios, McDowell buscó colflicto con los cristianos que encontr{o en la universidad. Se burló de sus creencias y menospreció su fe hasta que ellos le plantearon un desafío: prueba que Dios no eciste. De manera obsesiva, McDowell viajó por el mindo registrando municiosamente los textos históricos sagrados en busca de evidencia que contradijera el cristianismo. Lo que halló en lugar de ello fue la verdad y una fe que llevó a la gracia y redimió a un hombre quebrantado.', 'portadas/inquebrantable-DVD.jpg', 2, 'Estante 2', 1, 0, 5, 14, NULL, NULL, NULL),
(94, 1, '1-14', 'EN LA SELVA', '1RA MEDIA HORA ', 2014, '00:28:08', '', 'BOLIVIA', '', 36, '', '1', 'SÉPTIMA TEMPORADA:\r\nFABRICA DE CONFESIONES:\r\nSOY MAYOR DE EDAD PERO MIS PADRES ME CONTROLAN Y CHANTAJEAN. QUIERO IRME DE MI CASA, QUE HAGO?\r\n', 'X', 2, 'Estante 3 fila 5', 1, 0, 4, 152, NULL, NULL, NULL),
(95, 1, '01-13-P1', 'VASO FRAGIL', 'MARCELO VALDIVIA TESTIMONIO', 2013, '00:28:50', 'SILVIA CAMACHO', 'BOLIVIA', '', 1, 'XTO TV', '1', 'TESTIMONIO DE MARCELO VALDIVIA ACERCA DE LA FAMILIA', 'X', 2, 'ESTANTE 3 - FILA 6', 1, 0, 4, 55, NULL, NULL, NULL),
(96, 1, '1-14/2', 'EN LA SELVA', '2DA MEDIA HORA ', 2014, '00:14:20', '', '', '', 0, '', '1', '2DA MEDIA HORA: 2\r\nPYX CON YARE VARGAS', 'X', 2, 'Estante 3 fila 5', 1, 0, 4, 152, NULL, NULL, NULL),
(97, 1, '01-13 P2', 'VASO FRAGIL', 'MARCELO VALDIVIA TESTIMONIO', 2013, '00:28:20', 'SILVIA CAMACHO', 'BOLIVIA', '', 1, 'XTO TV', '1', 'TESTIMONIO DE MARCELO VALDIVIA SOBRE LA FAMILIA', 'X', 2, 'ESTANTE 3 FILA 6', 1, 0, 4, 55, NULL, NULL, NULL),
(98, 1, '1-14/3', 'EN LA SELVA', '2DA MEDIA HORA ', 2014, '00:14:16', '', 'BOLIVIA', '', 5, '', '1', '2DA MEDIA HORA/3\r\nGRUPO INVITADO PYX CON YARE VARGAS', 'X', 2, 'Estante 3 fila 5', 1, 0, 4, 152, NULL, NULL, NULL),
(99, 1, '02-13 P1', 'VASO FRAGIL', 'MARCELO VALDIVIA TESTIMONIO', 2013, '00:28:45', 'SILVIA CAMACHO', 'BOLIVIA', '', 1, 'XTO TV', '1', 'TESTIMONIO DE MARCELO VALDIVIA SOBRE SUS ADICCIONES ALCOHOL Y DROGAS', 'X', 2, 'ESTANTE 3 - FILA 3', 1, 0, 4, 55, NULL, NULL, NULL),
(100, 1, '02-13 P2', 'VASO FRAGIL', 'MARCELO VALDIVIA TESTIMONIO', 2013, '00:28:27', 'SILVIA CAMACHO', 'BOLIVIA', '', 1, 'XTO TV', '1', 'TESTIMONIO DE MARCELO VALDIVIA SOBRE SU ADICCION A \r\nLAS DROGAS', 'X', 1, 'ESTANTE 3 - FILA 6', 1, 0, 4, 55, NULL, NULL, NULL),
(101, 1, '2-14/1', 'EN LA SELVA', '1RA MEDIA HORA ', 2014, '00:28:30', '', '', '', 5, '', '1', '1RA MEDIA HORA:\r\nLECTURA: OREMOS EN EL ESPÍRITU POR JOYCE MEYER', 'X', 2, 'Estante 3 fila 5', 1, 0, 4, 152, NULL, NULL, NULL),
(102, 1, '2-14/2', 'EN LA SELVA', '2DA MEDIA HORA ', 2014, '00:11:30', '', 'BOLIVIA', '', 5, '', '1', '2DA MEDIA HORA:\r\nENTREVISTA A MAYRA GONZALES.', 'X', 2, 'Estante 3 fila 5', 1, 0, 4, 152, NULL, NULL, NULL),
(103, 1, '03-13 P1', 'VASO FRAGIL', 'MARCELO VALDIVIA TESTIMONIO', 2013, '00:27:50', 'SILVIA CAMACHO', 'BOLIVIA', '', 1, 'XTO TV', '1', 'TESTIMONIO DE MARCELOO VALDIVIA SOBRE LAS ADICCIONES Y SU RECUPERACION', 'X', 2, 'ESTANTE 3 - FILA 6', 1, 0, 4, 55, NULL, NULL, NULL),
(104, 1, '03-13 P2', 'VASO FRAGIL', 'MARCELO VALDIVIA TESTIMONIO', 2013, '00:28:00', 'SILVIA CAMACHO', 'BOLIVIA', '', 1, 'XTOO TV', '1', 'TESTIMONIO DE MARCELO VALDIVIA SOBRE LAS ADICCIONES Y SU RECUPERACION', 'X', 2, 'ESTANTE 3 - FILA 6', 1, 0, 4, 55, NULL, NULL, NULL),
(105, 1, '2-14/3', 'EN LA SELVA', '2DA MEDIA HORA/3', 2014, '00:11:31', '', '', '', 36, '', '1', '2DA MEDIA HORA:\r\nENTREVISTA A MAYRA GONZALES.', 'X', 2, 'Estante 3 fila 5', 1, 0, 4, 152, NULL, NULL, NULL),
(106, 1, '04-13 P1', 'VASO FRAGIL', 'MARCELO VALDIVIA TESTIMONIO', 2013, '00:28:00', 'SILVIA CAMACHO', 'BOLIVIA', '', 1, 'XTO TV', '1', 'TESTIMONIO DE MARCELO VALDIVIA SOBRE LAS ADICCIONES  SUS CARATERISTICAS ', 'X', 2, 'ESTANTE 3 - FILA 6', 1, 0, 4, 55, NULL, NULL, NULL),
(107, 1, '3-14', 'EN LA SELVA', '1RA MEDIA HORA ', 2014, '00:27:50', '', 'BOLIVIA', '', 36, '', '1', '1RA MEDIA HORA\r\nFABRICA DE CONFESIONES:\r\nFUI UNA PERSONA ENTREGADA A DIOS. NO ME CONGREGO POR PASIÓN SINO POR CUMPLIR. NECESITO AYUDA', 'X', 2, 'Estante 3 fila 5', 1, 0, 4, 152, NULL, NULL, NULL),
(108, 1, '3-14/2', 'EN LA SELVA', '2DA MEDIA HORA/2', 2014, '00:13:20', '', 'BOLIVIA', '', 36, '', '1', '2DA MEDIA HORA/2\r\nENTREVISTA:\r\nDIEGO CALDERÓN\r\n', 'X', 2, 'Estante 3 fila 5', 1, 0, 4, 152, NULL, NULL, NULL),
(109, 1, '3-14/3', 'EN LA SELVA', '2DA MEDIA HORA/3', 2014, '00:14:20', '', 'BOLIVIA', '', 36, '', '1', '2DA MEDIA HORA/3\r\nENTREVISTA:\r\nDIEGO CALDERÓN ', 'X', 2, 'Estante 3 fila 5', 1, 0, 4, 152, NULL, NULL, NULL);
INSERT INTO `material` (`id`, `ID_USU`, `COD_MAT`, `TIT_MAT`, `SUB_MAT`, `ANP_MAT`, `DUR_MAT`, `DIR_MAT`, `PAI_MAT`, `GUI_MAT`, `ID_GEN`, `EST_MAT`, `RES_MAT`, `COM_MAT`, `POR_MAT`, `ID_UBI`, `DES_UBI`, `ACT_MAT`, `NRO_PRO`, `ID_PRO`, `ID_ARC`, `created_at`, `updated_at`, `TAG_MAT`) VALUES
(110, 3, 'ELS/01', 'En la selva', '2da Media hora', 2016, '00:59:56', 'Silvia camacho', 'Bolivia', '', 36, 'XTO TV', '1', 'Programa de los jovenes, confesionario', 'base de datos expertos.png', 1, 'Estante 3 ', 1, 2, 4, 21, '2016-07-01 04:01:10', '2016-07-01 04:01:10', NULL),
(111, 3, 'ELS/01', 'En la selva', '2da Media hora', 2016, '00:59:56', 'Silvia camacho', 'Bolivia', '', 36, 'XTO TV', '1', 'Programa de los jovenes, confesionario', 'base de datos expertos.png', 1, 'Estante 3 ', 1, 2, 4, 21, '2016-07-01 04:03:10', '2016-07-01 04:03:10', NULL),
(112, 3, 'ELS/02', 'En la selva', '1ra Media hora', 2016, '00:58:15', 'Silvia Salcedo', 'Bolivia', '', 36, 'XTO TV', '2', 'Programa juvenil de enseñanza ', 'f99fdde4c0f6ea33734030ba85802361.png', 2, 'Mis documentos', 1, 1, 4, 21, '2016-07-01 04:41:41', '2016-07-01 04:41:41', NULL),
(113, 3, 'ELS/03', 'En la selva', '3ra Media hora', 2016, '00:30:25', 'Silvia Salcedo', 'Bolivia', '', 36, 'XTO TV', '1', 'Programa juvenil, continuacion ', 'X', 2, 'C:/Videos', 1, 1, 4, 21, '2016-07-01 04:53:43', '2016-07-01 04:53:43', NULL),
(114, 3, 'ELS/03', 'En la selva', '3ra Media hora', 2016, '00:30:25', 'Silvia Salcedo', 'Bolivia', '', 36, 'XTO TV', '1', 'Programa juvenil, continuacion ', 'X', 2, 'C:/Videos', 1, 1, 4, 21, '2016-07-01 04:54:01', '2016-07-01 04:54:01', NULL),
(115, 3, 'HAM-01', 'Hombria al maximo', 'Hombres de valor', 2014, '01:58:22', 'Alberto Salcedo', 'Bolivia', '', 21, 'Casa de la casa', '2', 'Predica de enseñanza en la casa de la casa', 'hombria-al-maximo-nueva-fecha.jpg', 1, 'Estante 4', 1, 1, 4, 20, '2016-07-01 05:15:15', '2016-07-01 05:15:15', NULL);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `materialsumma`
--

CREATE TABLE `materialsumma` (
  `id` int(11) NOT NULL,
  `NOM_MSU` text,
  `PRE_MSU` float DEFAULT NULL,
...
INSERT INTO `paquetes` (`id`, `NOM_PAQ`, `PRE_PAQ`, `ID_USU`, `created_at`, `updated_at`) VALUES
(2, 'Paquete plus 2x1', 40, 3, '2017-01-30 14:09:48', '2017-01-30 14:09:48'),
(3, 'Pack Jose Ordoñez', 50, 3, '2017-03-28 03:01:35', '2017-03-28 03:01:35');
...
(1, 'Wilson', 'Yujra', 'G', '9959333', 0, '$2y$10$AOxQD9yvSJuFr0w1GSr1demH0LLVD/B0M.blxwL7tdb68f4ABDCk.', 'omrdOz4H5ztbLEh4RZQsI42sj3wzn7fyXWmfrlf5EH9XG6mBaQMsfXaLmPZg', '2016-04-01 23:51:23', '2017-01-30 16:19:08'),
(3, 'Luis Felipe', 'Quisbert', 'Quispe', '7074342', 0, '$2y$10$.fCLTZnDbzAvspFj8xB0Teamumg8hpezwXqxLHB93cdu7CzjmnXtS', 'i8UNdOoFLy5qLiT7bcYpIljNq3asIEExFzBPdEmBioRJYag7e7kVi8lz5Hwb', '2016-04-01 23:51:23', '2017-04-20 18:29:56'),
(6, 'Juan', 'Laura', 'Villca', 'juanca', 1, '$2y$10$uf3yEzoSo8cD6yfCpKHZwuZ7R4O9dFk4oY6aP.uAYKhe0FwlV3lKG', 'QETqUMoAkdUmri6nKm8BqHkPmh4MWHHmmwynVvJ0jQHhmAKR3qOLkqxR0eC8', '2016-06-04 02:58:03', '2017-01-30 16:11:12');
...
INSERT INTO `vendidos` (`id`, `CAN_VND`, `ID_PRO`, `ID_VEN`, `created_at`, `updated_at`) VALUES
(1, 2, 1, 1, '2017-01-30 14:37:53', '2017-01-30 14:37:53'),
(2, 3, 1, 4, '2017-01-30 14:39:38', '2017-01-30 14:39:38'),
(3, 3, 1, 5, '2017-01-30 14:40:37', '2017-01-30 14:40:37'),
(4, 1, 1, 6, '2017-01-30 18:45:16', '2017-01-30 18:45:16'),
(8, 3, 1, 25, '2017-01-30 22:04:49', '2017-01-30 22:04:49'),
(9, 2, 4, 25, '2017-01-30 22:04:49', '2017-01-30 22:04:49'),
(10, 7, 1, 26, '2017-01-30 23:18:45', '2017-01-30 23:18:45'),
(11, 5, 4, 26, '2017-01-30 23:18:45', '2017-01-30 23:18:45'),
(12, 5, 2, 26, '2017-01-30 23:18:45', '2017-01-30 23:18:45'),
(13, 22, 2, 27, '2017-03-26 04:26:32', '2017-03-26 04:26:32'),
(14, 3, 1, 28, '2017-03-28 03:00:40', '2017-03-28 03:00:40'),
(15, 1, 2, 28, '2017-03-28 03:00:40', '2017-03-28 03:00:40'),
(16, 1, 4, 28, '2017-03-28 03:00:41', '2017-03-28 03:00:41'),
(17, 1, 1, 29, '2017-03-28 03:10:58', '2017-03-28 03:10:58'),
(18, 4, 2, 30, '2017-04-20 18:28:02', '2017-04-20 18:28:02'),
(19, 1, 4, 30, '2017-04-20 18:28:02', '2017-04-20 18:28:02');
...
CREATE TABLE `ventas` (
  ...
  `DEP_VEN` text,
  `FAC_VEN` int(11) DEFAULT NULL,
  `ID_CLI` int(10) UNSIGNED DEFAULT NULL,
...
INSERT INTO `ventas` (`id`, `FEC_VEN`, `DEP_VEN`, `FAC_VEN`, `ID_CLI`, `ID_USU`, `created_at`, `updated_at`) VALUES
(1, '2016-12-12', NULL, 2147483647, 21, 3, '2017-01-30 14:37:53', '2017-01-30 14:37:53'),
(4, '2016-12-12', NULL, 2335364, 21, 3, '2017-01-30 14:39:38', '2017-01-30 14:39:38'),
(5, '2016-12-12', NULL, 2335364, 12, 3, '2017-01-30 14:40:37', '2017-01-30 14:40:37'),
(6, '2015-12-12', NULL, 54532432, 12, 3, '2017-01-30 18:45:16', '2017-01-30 18:45:16'),
(25, '2009-12-12', NULL, 2147483647, 12, 3, '2017-01-30 22:04:49', '2017-01-30 22:04:49'),
(26, '2016-12-29', NULL, 2147483647, 2, 3, '2017-01-30 23:18:44', '2017-01-30 23:18:44'),
(27, '2017-03-09', NULL, 2147483647, 2, 3, '2017-03-26 04:26:32', '2017-03-26 04:26:32'),
(28, '2017-03-10', NULL, 2147483647, 1, 3, '2017-03-28 03:00:40', '2017-03-28 03:00:40'),
(29, '2017-03-27', NULL, 123456, 2, 3, '2017-03-28 03:10:58', '2017-03-28 03:10:58'),
(30, '2017-04-20', NULL, 646273747, 4, 3, '2017-04-20 18:28:02', '2017-04-20 18:28:02');
...
ALTER TABLE `articulos`
  ADD PRIMARY KEY (`id`),
  ADD KEY `articulos_id_cat_foreign` (`ID_CAT`),
  ADD KEY `material_idx` (`ID_MAT`);
...
ALTER TABLE `categorias`
  ADD PRIMARY KEY (`id`),
  ADD KEY `categorias_id_usu_foreign` (`ID_USU`);
...
ALTER TABLE `empaquetados`
  ADD PRIMARY KEY (`id`),
  ADD KEY `empaquetados_id_paq_foreign` (`ID_PAQ`),
  ADD KEY `empaquetados_id_art_foreign` (`ID_ART`);
...
--
-- Indices de la tabla `materialsumma`
--
ALTER TABLE `materialsumma`
  ADD PRIMARY KEY (`id`),
  ADD KEY `materialsumma_idx` (`ID_MAT`);
...
ALTER TABLE `paquetes`
  ADD PRIMARY KEY (`id`),
  ADD KEY `paquetes_id_usu_foreign` (`ID_USU`);
...
ALTER TABLE `users`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `users_nic_usu_unique` (`NIC_USU`);
...
ALTER TABLE `vendidos`
  ADD PRIMARY KEY (`id`),
  ADD KEY `vendidosproducto_idx` (`ID_PRO`),
  ADD KEY `vendidosventa_idx` (`ID_VEN`);
...
ALTER TABLE `ventas`
  ADD PRIMARY KEY (`id`),
  ADD KEY `clienteventa_idx` (`ID_CLI`),
  ADD KEY `usuarioventa_idx` (`ID_USU`);
...
--
-- AUTO_INCREMENT de la tabla `materialsumma`
--
ALTER TABLE `materialsumma`
...
ALTER TABLE `articulos`
  ...
  ADD CONSTRAINT `material` FOREIGN KEY (`ID_MAT`) REFERENCES `material` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
--
-- Filtros para la tabla `materialsumma`
--
ALTER TABLE `materialsumma`
  ADD CONSTRAINT `materialsumma` FOREIGN KEY (`ID_MAT`) REFERENCES `material` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
--
ALTER TABLE `vendidos`
  ADD CONSTRAINT `vendidosproducto` FOREIGN KEY (`ID_PRO`) REFERENCES `articulos` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `vendidosventa` FOREIGN KEY (`ID_VEN`) REFERENCES `ventas` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `ventas`
--
ALTER TABLE `ventas`
  ADD CONSTRAINT `clienteventa` FOREIGN KEY (`ID_CLI`) REFERENCES `clientes` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `usuarioventa` FOREIGN KEY (`ID_USU`) REFERENCES `users` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

@extends('../layout')
@section('title')
  Administrador - Material programacion (Area restringida)
@endsection
  @section ('cuerpo')
  <div class="panel panel-success cuerpo">
  <div class="panel-heading titleform" >ADMINISTRACION DE MATERIAL - SCC </div>
  ...
  <tbody style="font-size:11px;">
    ...
    <?php
          ...
          ?>
            ...
            <th><?php echo $mat->COD_MAT;?></th>
            <th><?php echo $mat->TIT_MAT;?></th>
            <th><?php echo $mat->SUB_MAT;?></th>
            <th><?php echo $mat->DUR_MAT;?></th>
            <th><?php echo $mat->DES_UBI;?></th>
            <th style=" width:85px; ">
                <button data-toggle = "modal" data-target = "#myModal2" onClick="modificar(<?php echo "'$mat->titulo'".','."'$mat->activo'".','."'$mat->id"."'";?>);" class="btn btn-primary" title="Modificar datos de matero"> <span class="glyphicon glyphicon-pencil" style="font-size:12px;"> </span> </button> <button data-toggle = "modal" data-target = "#myModal3" onClick="eliminar(<?php echo $mat->id;?>);" class="btn btn-danger" title="Eliminar cliente"> <span class="glyphicon glyphicon-trash"  style="font-size:12px;"></span> </button> </th>

		...
		<div class="collapse navbar-collapse navbar-ex1-collapse">
			<ul class="nav navbar-nav">
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu">
						...
						<li><a href="#">· Realizar prestamo de material</a></li>
						<li><a href="#">· Enviar promociones via e-mail a clientes</a></li>
						<li><a href="#">· Realizar una copia de seguridad</a></li>
					</ul>
				</li>
				<li class="dropdown">
			...
			<ul class="nav navbar-nav navbar-right">
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu">
						<li><a href="#"><span class="glyphicon glyphicon-bishop colorspan"> </span>· Ver perfil</a></li>
...
<nav class="navbar navbar-default sidebar" role="navigation">
    ...
    <div class="collapse navbar-collapse" id="bs-sidebar-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown">Administrar <span class="caret colorspan"></span><span style="font-size:16px;" class="pull-right hidden-xs showopacity glyphicon glyphicon-shopping-cart colorspan"></span></a>
          <ul class="dropdown-menu forAnimate" role="menu">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu forAnimate" role="menu">
            <li><a href="#">· Material XTO TV(prog)</a></li>
      ...
      <div class = "modal-content">
         ...
         <div class = "modal-body">
            	...
            	<label class="col-lg-3 control-label">Nombre :</label>
         		<div class="col-md-8">
           		 <input placeholder="NOMBRE DE LA CATEGORIA" required class="form-control" name="nom_alm">
        		</div>
         		</div>
         <div class="form-group">
            <label class="col-lg-3 control-label">Descripcion :</label>
         <div class="col-md-8">
            <input class="form-control" name="ubi_alm" required placeholder="DESCRIPCION DE LA CATEGORIA" id="descomp">
         </div>
         </div>

			...
			<ul class="nav navbar-nav">
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu">
						<li><a href="hojaprogramacion">· Elaborar hoja de programacion</a></li>
    ...
    <div class="collapse navbar-collapse" id="bs-sidebar-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu forAnimate" role="menu">
            <li><a href="adminusu">· Administrar usuarios</a></li>
            <li><a href="admincli">· Administrar clientes</a></li>
						<li><a href="adminven">· Administrar ventas</a></li>
						<li><a href="admingen">· Administrar generos</a></li>
						<li><a href="adminart">· Administrar articulos</a></li>
						<li><a href="adminpro">· Administrar Procedencia</a></li>
            <li><a href="adminpaq">· Administrar paquetes</a></li>
            <li><a href="admincat">· Administrar categorias</a></li>
            <li><a href="adminmat">· Administrar material</a></li>
            <li><a href="adminpen">· Pendientes</a></li>
          </ul>
        </li>
        <li class="">
